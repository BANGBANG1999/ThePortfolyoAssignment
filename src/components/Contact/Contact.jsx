...
const Contact = ({ data, socialData, apiRes }) => {
            ...
            <div className="st-contact-info-wrap">
              <div className="st-single-contact-info">
                ...
                <div className="st-single-info-details">
                  <h4>Email</h4>
                  <Link to="#">{apiRes.user.email}</Link>
              ...
              <div className="st-single-contact-info">
                ...
                <div className="st-single-info-details">
                  <h4>Phone</h4>
                  <span>{apiRes.user.about.phoneNumber}</span>
              ...
              <div className="st-single-contact-info">
                ...
                <div className="st-single-info-details">
                  <h4>Address</h4>
                  <span>{apiRes.user.about.address}</span>
                </div>
              </div>
              <div className="st-social-info">
                <div className="st-social-text">{subTitle}</div>
                <SocialLinks data={socialData} apiRes={apiRes} />
              </div>
            </div>
          </div>
        </div>
